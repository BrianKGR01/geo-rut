...
export function ErrorScreen({ onRetry }: ErrorScreenProps) {
  return (
    <div className="app-shell flex flex-col items-center justify-center gap-4 bg-page px-6 text-center" role="alert">
      <h1 className="font-display text-4xl font-bold uppercase tracking-wide">Algo salió mal</h1>
